...
Prediction market prices on traded real-money venues embed a positive price--probability wedge that reverses sign on the play-money platform Manifold, consistent with risk-bearing costs dominating on traded venues and confidence-related distortions dominating absent financial stakes. Identifying the structural source of the wedge requires richer microdata or exogenous variation; but the sign reversal itself shows that prediction market prices cannot always be read literally as probabilities.
