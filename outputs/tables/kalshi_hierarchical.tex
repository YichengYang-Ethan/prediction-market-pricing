...
\centering
\small
\caption{One-stage hierarchical Wang MLE on Kalshi contracts. Dependent variable: binary outcome $y_i$. Model: $\Pr(y_i = 1) = \Phi(\Phi^{-1}(p_i^{\text{mkt}}) - X_i\beta)$. Fisher standard errors reported; sandwich robust SEs in brackets.}
