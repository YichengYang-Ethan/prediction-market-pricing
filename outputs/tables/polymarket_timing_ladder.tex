...
\centering
\small
\caption{Polymarket timing ladder: one-stage hierarchical Wang MLE estimated at different lifecycle pricing points. The Kalshi pooled estimate (using near-settlement prices) is shown in the last row for comparison. Robust (sandwich) standard errors in parentheses.}
